...
class _TeamManagementScreenState extends State<TeamManagementScreen> {
  ...
  Future<void> _updateJoinRequestStatus(String requestId, String status) async {
    try {
      await _apiService.updateJoinRequestStatus(widget.teamId, requestId, status);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_team?.name ?? LocalizationService().translate('team_management')),
        leading: IconButton(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                if (_team!.location != null)
                                                  Text(_team!.location!),
                                                Text('${LocalizationService().translate('max_players')}: ${_team!.maxPlayers}'),
                                              ],
                                            ),
                                          ),
                                        ],
