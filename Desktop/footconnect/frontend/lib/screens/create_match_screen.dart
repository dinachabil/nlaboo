...
class _CreateMatchScreenState extends State<CreateMatchScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${LocalizationService().translate('failed_to_load_teams')}: $error')),
        );
      }
    }
  }
  ...
  Future<void> _createMatch() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(LocalizationService().translate('match_created_successfully'))),
        );
        context.go('/home');
      }
    } catch (error) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${LocalizationService().translate('error')}: $error'),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: LocalizationService().translate('match_title_hint'),
                            prefixIcon: Icon(
                              Icons.title,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: LocalizationService().translate('location_hint'),
                            prefixIcon: Icon(
                              Icons.location_on,
                              color: Theme.of(context).colorScheme.onSurface.withOpacitySafe(0.6),
                            ),
                        ...
                        // Total Players
                        Text(
                          LocalizationService().translate('total_players'),
                          style: Theme.of(context).textTheme.titleMedium?.copyWith(
                            fontWeight: FontWeight.w600,
                            color: Theme.of(context).colorScheme.onSurface,
                          ),
                        ...
                        DropdownButtonFormField<int>(
                          ...
                          validator: (value) => validateTotalPlayers(value),
                        ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return LocalizationService().translate('match_type_required');
                            }
                            return null;
                          },
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: (_isLoading || _isSubmitting) ? null : _createMatch,
