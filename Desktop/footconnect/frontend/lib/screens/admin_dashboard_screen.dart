                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading: CircleAvatar(
                                  ...
                                  // Show initial if no image (guarded to avoid substring on empty names)
                                  child: imageUrl == null
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        color: user.isAdmin
                                            ...
                                            : Theme.of(context).colorScheme.onSurface.withOpacitySafe(0.7),
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: match.isOpen
                                                ...
                                                : Colors.red.withOpacitySafe(0.1),
                                            borderRadius: BorderRadius.circular(12),
                                          ),
                                          child: Text(
                                            (match.status).toUpperCase(),
                                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                              color: match.isOpen ? Colors.green : Colors.red,
                                              fontWeight: FontWeight.w600,
                                            ),
                                          ),
                                        ),
                                      ...
                                      Align(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: ElevatedButton.icon(
                                            onPressed: () => _showCloseMatchDialog(match),
